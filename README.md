# Fundamentos IA - Trabalhos práticos
...
2. Entre na pasta do TP desejado.
3. Leia o `README.md` da pasta para saber dependencias e como rodar scripts ou notebooks.

Padronizacao: `docs/` para PDFs, `notebooks/` para notebooks, `data/` para dados de entrada e `results/` para figuras ou resultados.
